...
no_of_halls int not null,
no_of_consultancy_rooms int not null,
...
time_of_admission timestamp default now() not null,
check (p_id like 'P%'),
check (d_id like 'd%'),
...
type_of_test varchar(50) unique not null,
...
ventilator_in_use int not null,
beds_in_use int not null,
oxygen_cylinders_in_use int not null
);

create table posthumus(
id varchar(10) primary key,
p_id varchar(8) not null,
timingofdeath timestamp default now() not null,
age int not null,
cause_of_death varchar(15) not null,
